            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <a href="{{ route('details.plan.index',$item->url) }}" class="btn btn-primary" title="Dtalhes do plano">DETALHES</a>
                        <a href="{{ route('plans.edit',$item->url) }}" class="btn btn-info">EDITAR</a>
                        <a href="{{ route('plans.show',$item->url) }}" class="btn btn-warning">VER</a>
                        <a href="{{ route('plans.profiles',$item->id) }}" class="btn btn-warning"><i class="fas fa-address-book"></i></a>
                    </td>
                </tr>    
                @endforeach
            </tbody>
