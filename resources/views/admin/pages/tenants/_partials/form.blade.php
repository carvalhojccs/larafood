...
<div class="form-group">
    <label>Nome:</label>
    <input type="text" name="name" class="form-control" placeholder="Nome da empresa" value="{{ $data->name ?? old('name') }}">
</div>
<div class="form-group">
    <label>Logo:</label>
...
<div class="form-group">
    <label>Email:</label>
    <input type="email" name="email" class="form-control" placeholder="E-mail" value="{{ $data->email ?? old('email') }}">
</div>
<div class="form-group">
    <label>CNPJ:</label>
    <input type="number" name="cnpj" class="form-control" placeholder="CNPJ da empresa" value="{{ $data->cnpj ?? old('cnpj') }}">
</div>
<div class="form-group">
    <label>Ativo?</label>
